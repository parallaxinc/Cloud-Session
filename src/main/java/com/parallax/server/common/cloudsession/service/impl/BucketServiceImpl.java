...
public class BucketServiceImpl implements BucketService {
    ...
    @Override
    public boolean consumeTokens(Long idUser, String type, int tokenCount) throws UnknownBucketTypeException, UnknownUserIdException {
        ...
        if (bucket.getContent() == -1) {
            ...
            // Add tokens depending on timestamp (no more then bucket size
