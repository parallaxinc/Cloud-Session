...
public class RestAPIVisualizeBootstrap extends VzBootstrapContextListener {
    ...
    public void contextInitialized(ServletContextEvent contextEvent) {
        ...
        applicationConfigurationContext.setApplicationName("Common Session REST Api");
    ...
    private void setConfiguration() {
        ...
        display.setHeader("Cloud session REST service API Documentation");
        display.setTittle("Cloud session REST service API Documentation");
        display.setLogoInclude(true);
        display.setLogoUrl("https://jersey.java.net/images/jersey_logo.png");
        Description description = new Description();
        description.setHeader("Cloud session REST API Documentation");
        description.setDetail("Usage of the cloud session REST API");
