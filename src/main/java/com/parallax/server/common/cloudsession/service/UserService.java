...
public interface UserService {
    ...
    UserRecord register(String server, String email, String password, String passwordConfirm, String locale) throws PasswordVerifyException, NonUniqueEmailException;
