 ...
 * @author Michel
 */
public class BucketServiceImplOneTokenTest {
    ...
    public void consumeTokenIntenalTestSufficientFull() {
        ...
        try {
            bucketService.consumeTokensInternal(1L, "test", 1);
            Assert.assertEquals(new Integer(4), bucketRecord.getContent());
